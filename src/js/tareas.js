(function() { 
    ...
    let filtradas = [];
     ...
     // Botón para mostrar el Modal de Agregar tareas
    ...
    modal.addEventListener('click', function(e) {
        ...
        if(e.target.classList.contains('submit-nueva-tarea')) {
            ...
            if(nombretarea === '') {
                ...
                mostrarAlerta('El Nombre de la Tarea es obligado', 'error',
     ...
     // Muestra un mensaje en el interfaz
     function mostrarAlerta(mensaje, tipo, referencia) {
        ...
        // Eleminar la alerta despues de 10 segundos
        setTimeout(() => { 
            alerta.remove();
        }, 500)
     }
     ...
     async function agregarTarea(tarea) {
        ...
        try {
          ...
          if(resultado.tipo === 'exito') {
            ...
            // Agreagar el objeto de tarea al global de tareas
            const tareaObj = {
